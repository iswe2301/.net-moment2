...
namespace Moment2_MVC.Models
{
    ...
    public class ContactFormModel
    {
        ...
        [Required(ErrorMessage = "E-postadress är obligatorisk.")] // Validering för e-postadress (obligatorisk)
        ...
        [Required(ErrorMessage = "Du måste välja ämne.")] // Validering för ämne (obligatorisk)
